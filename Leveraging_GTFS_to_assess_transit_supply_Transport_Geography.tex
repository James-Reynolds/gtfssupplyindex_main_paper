...
\centering
\fontsize{7}{9}\selectfont
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{2cm}|>{\raggedleft\arraybackslash}p{1.16cm}|>{\raggedleft\arraybackslash}p{1.16cm}|>{\raggedleft\arraybackslash}p{1.16cm}|>{\raggedleft\arraybackslash}p{1.16cm}|>{\raggedleft\arraybackslash}p{1.16cm}|>{\raggedleft\arraybackslash}p{1.16cm}|>{\raggedleft\arraybackslash}p{2cm}}
\hline
transit\_supply & Very Low & Low & Below average & Above average & High & Very High & Total\\
\hline
