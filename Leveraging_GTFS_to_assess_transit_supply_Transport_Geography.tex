...
Providing at least some motorised mobility for those who cannot
otherwise drive themselves is a motivation for transit service provision
in many places \citep{Currie:2016aa}. Age, disability, socio-economic
status, lack of a driver's license or vehicle, and many other factors
might make someone reliant on transit services for some or all of their
travel. Social-equity perspectives on transport policy-making,
especially those seeking to improve vertical equity so as to better
support those who are disadvantaged (c.f. \citet{Litman:2016aa}), might
therefore suggest providing at least some transit, and probably more
than just a minimum, to places that have the highest social need for
transport. Previous research developed an approach for identifying
spatial gaps in transit supply related to social needs for transport and
applied this to a case study of Melbourne in 2006 \citetext{\citealp[
\citet{Currie2004Gap}]{Currie2003Hobart}; \citealp{Currie2007Identifying}; \citealp{currie2010identifying}}.
...
supply and social needs in other places, or if the situation in
...
was a large task. Nowadays, more than 10,000 transit agencies publicly
release timetable data in the General Transit Feed Specification (GTFS)
format \citep{GTFS}. Such standardisation allows Google Maps and other
online platforms to provide transit-related outputs for any place with a
GTFS feed, and has facilitated research about transit service provision.
However, tools for using GTFS data to examine spatial patterns and gaps
...
analysis reported in \citet{currie2010identifying}\footnote{The wider
  ...
  examining Melbourne only, and results for other cities will be
  reported elsewhere.}.
...
There are many metrics available for assessing transit services, with
...
reported for 2006 in \citet{currie2010identifying}.

Addressing the ``duality criterion'' is a key issue when using case
research approaches, this being the need of the research to be seeking
...
Using these methods addresses the duality criterion for the first
research question, as the developed software functions are generic. They
are applicable to other GTFS feeds, and could be used to analyse spatial
gaps in transit supply in other places (and by others), beyond the
Melbourne case reported in this paper. The recommendations of
...
to define areas of interest. This was sourced via the strayr and
absmapsdata packages \citep{r-strayr}.
...
last 10 to 15 years. As such, SI scores where calculated using the same
...
\citet{currie2010identifying}, with those CCDs/SA1s that have above
average SI scores split evenly into three groups, those that have below
average SIs also split evenly into three groups, and those CCDs/SA1s
with SI scores of zero placed in their own category.
...
6,325 CCDs within the 2006 Melbourne boundary. This suggests that the
results found here are not directly comparable to those in
\citet{currie2010identifying} due to geographic inconsistencies. Overall
results, however, appear to be consistent with there having been
increases in SI scores across all parts of Melbourne since 2006, but a
similar pattern of higher average SI scores in inner and then middle
suburbs.
...
Using all of Greater Melbourne and the 2021 definition of SA1s indicates
that there is a significant and strong correlation between the 2016 and
2021 SI scores (\(r(11485) = 1.00\), \(p < .001\), \(r_s =.98\),
\(p < .001\)). Average SI scores increased from NA in 2016 to NA in 2021
(+NA). Table
\ref{tab:Greater_Melbourne_2016_2021_ratio_population_table} shows
changes in SI score between 2016 and 2021 (column 1) by 2021 SA1s for
the 2021 population, summarised for each SA4 zone (columns 2 to 10) and
...
level changes across the populations between SA4 areas
(\(\chi^2(88, N = 4917633) = 1220826.77\), \(p < .001\)). More than half
of the population in the North-West, West, North East, South East,
Mornington Peninsula and Inner SA4s had SI scores that were higher in
2021 by one or more percent than they had been in 2016. Service levels
remained within one percent for 52.9\% of the population in the Outer
East and 50.3\%. More of the population had less service in 2021 than
2016 in the Inner (28.3\%), Inner South (23.9\%) and Outer East (22.0\%)
than in other SA4s. In terms of overall population, however, the largest
shares to have at least one percent more service in 2021 were in the
west (581,781 residents in 2021), South East (432,712) and the Inner
(313,650) SA4 areas. The largest shares of residents with at less one
percent lower service level in 2021 were among the Inner (174,615),
Outer East (114,281) and South East (107,976) SA4 areas.
...
Melbourne for 2021\footnote{A map for 2016 is included in the Appendix
  as Figure
  \textbackslash ref\{Greater\_Melbourne\_2016\_social\_needs\_appendix}.
...
grouping of different levels of social need appears less consistent in
2021 than in 2006. However, this may be an artifact of the shift to SA1s
from CCDs\footnote{CCDs were originally devised to group the
...
social needs and SI scores\footnote{To improve the clarity of the
  ...
  name, so as to given an indication of with suburbs of Melbourne are at
  each of the extremes.}. There is a significant, but only weakly
...
have transport supplies that have higher than the average. 301,743
people live within SA1s that have Zero or Very Low transport supply, but
Very High social needs. This represents 6.7\% of the 4,471,171 people
within Greater Melbourne, and is higher proportion than that reported
for 2006 (139,004 of 3.3 million people (4.2\%)).
...
of having the largest needs-gaps between 2006 and 2016, but are back in
this category again in 2021.
