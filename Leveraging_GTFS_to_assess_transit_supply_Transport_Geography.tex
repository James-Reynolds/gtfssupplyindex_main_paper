...
\begin{figure}
\includegraphics[width=1\linewidth]{Leveraging_GTFS_to_assess_transit_supply_Transport_Geography_files/figure-latex/Greater_Melbourne_CCD_2021-1} \caption{Transport Supply by CCD, week starting the day of the 2021 census}\label{fig:Greater_Melbourne_CCD_2021}
\end{figure}
...
boundaries as shown in Figure \ref{fig:Currie_map_SI}.

Comparing Figures \ref{fig:Currie_map_SI} and
\ref{fig:Greater_Melbourne_CCD_2021} suggests:

\begin{itemize}
\tightlist
\item
  Overall spatial patterns appear generally similar in 2021 as in
  2006,\\
...
\item
  ...
  especially in outer areas. However, .\\
  Transit supply also appears to be more spread out in 2021 than in
  2006, with higher levels of transit supply provided in many middle and
  outer locations.
\end{itemize}
