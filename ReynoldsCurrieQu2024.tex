...
{\centering \subfloat[Bus Route 798 as originally introduced in 2014 (Source: Delbosc et al (2015))\label{fig:Bus_798-1}]{\includegraphics[width=0.5\linewidth]{graphics/Route798} }\subfloat[Current (2024) route map (Source: PTV)\label{fig:Bus_798-2}]{\includegraphics[width=0.5\linewidth]{graphics/Selandra_Rise} }
...
{\centering \subfloat[Transport Supply categories in 2016\label{fig:Selandra_rise-1}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-1} }\subfloat[Transport Supply categories in 2021\label{fig:Selandra_rise-2}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-2} }\newline\subfloat[Social Need categories in 2021\label{fig:Selandra_rise-3}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-3} }\subfloat[Very High Social Needs: Transport Supply categories in 2021\label{fig:Selandra_rise-4}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-4} }\newline\subfloat[Change in SI score between 2016 and 2021\label{fig:Selandra_rise-5}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-5} }\subfloat[Very High Social Needs, Very Low or Zero Supply (2021): Change in SI score between 2016 and 2021\label{fig:Selandra_rise-6}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-6} }\newline

}

\caption{Cranbourne and the Selandra Rise Estate (2021 SA1 boundaries)}\label{fig:Selandra_rise}
\end{figure}
