...
{\centering \subfloat[Transport Supply categories in 2016\label{fig:Selandra_rise-1}]{\includegraphics[width=0.5\linewidth]{graphics/Route798} }\subfloat[Transport Supply categories in 2021\label{fig:Selandra_rise-2}]{\includegraphics[width=0.5\linewidth]{graphics/Selandra_Rise} }\newline\subfloat[Change in SI score between 2016 and 2021 for SA1s with Very High needs but Very Low or Zero supply with 2021 populations\label{fig:Selandra_rise-3}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-3} }\subfloat[Current (2024) route map\label{fig:Selandra_rise-4}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-4} }\newline\subfloat[Transport Supply categories in 2016\label{fig:Selandra_rise-5}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-5} }\subfloat[Transport Supply categories in 2021\label{fig:Selandra_rise-6}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-6} }\newline\subfloat[Change in SI score between 2016 and 2021 for SA1s with Very High needs but Very Low or Zero supply with 2021 populations\label{fig:Selandra_rise-7}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-7} }\subfloat[Current (2024) route map\label{fig:Selandra_rise-8}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-8} }\newline\subfloat[Transport Supply categories in 2016\label{fig:Selandra_rise-9}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-9} }
