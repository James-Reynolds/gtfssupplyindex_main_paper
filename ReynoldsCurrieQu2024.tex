...
Campus},city={Melbourne},postcode={3800},state={Victoria},country={Australia},}
  ...
  \begin{abstract}
  Transit often provides a vital social purpose, linking those who
  cannot otherwise drive to services and activities beyond
  walking/cycling distance. Vertical social equity perspecties on
  transport policy might emphasise providing more service to those most
  in need, and previous research developed an analysis approach for
  identifying spatial areas where gaps between transit supply
  (accounting for both frequency and coverage) and transport needs are
  larger. However, this approach does not appear to have been widely
  adopted in practice, nor received much further attention from
  researchers. This may be due to the challenges associated with
  assessing transit supply levels at the time of publication, which was
  prior to the widespread avaialbility of schedule data in electronic
  formats. However, GTFS datasets are now provided by many operators,
  but software tools for needs-gap analysis do not appear to have yet
  been developed, nor is it known how spatial patterns of social
  needs-gaps have changed since the 2006 results reported previously.
  This paper reports development of an R package of tools for using GTFS
  datasets for needs-gap analysis and results for Melbourne in 2016 and
  2021. Results indicate similar patterns of social need and transit
  supply as in 2006, with lower supply levels in outer areas and away
  from the rail network. However, the number of residents living in
  areas with Very High needs but Very Low or Zero transit supply has
  increased by 140\% from 139,004 (4.2\%) in 2006 333,887 people
  (6.8\%). In comparison, the overall Melbourne population increased by
  only 46\% from 3.4m to 4.9m. The paper also briefly revists a case
  ...
  service appear to remain a challenge. While Melbourne may be an
  outlier in terms of population growth and (low) density, compared to
  other cities, theses results might suggest that providing even a basic
  level of transit-based movility to those in need has only become more
...
\hfill{}\subfloat[Transport Supply by SA1: 2016\label{fig:Selandra_rise-1}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-1} }\subfloat[Transport Supply by population: 2016\label{fig:Selandra_rise-2}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-2} }\newline\subfloat[Transport Supply by SA1: 2021\label{fig:Selandra_rise-3}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-3} }\subfloat[Transport Supply by population: 2021\label{fig:Selandra_rise-4}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-4} }\newline\subfloat[Change in SI score between 2016 and 2021 by SA1\label{fig:Selandra_rise-5}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-5} }\subfloat[...by 2021 population\label{fig:Selandra_rise-6}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-6} }\newline
...
\hfill{}\subfloat[Social Need by SA1: 2016\label{fig:Selandra_rise_2021-1}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise_2021-1} }\subfloat[Social Need by population: 2016\label{fig:Selandra_rise_2021-2}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise_2021-2} }\newline\subfloat[SA1s with Very High needs and Very Low or Zero supply in 2016, change in SI by 2021\label{fig:Selandra_rise_2021-3}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise_2021-3} }\subfloat[...by 2016 population\label{fig:Selandra_rise_2021-4}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise_2021-4} }\newline\subfloat[Social Need by SA1: 2021\label{fig:Selandra_rise_2021-5}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise_2021-5} }\subfloat[Social Need by population: 2021\label{fig:Selandra_rise_2021-6}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise_2021-6} }\newline\subfloat[SA1s with Very High needs in 2021, Supply by SA1\label{fig:Selandra_rise_2021-7}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise_2021-7} }\subfloat[...by population\label{fig:Selandra_rise_2021-8}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise_2021-8} }\newline
