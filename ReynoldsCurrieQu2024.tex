...
A common role for transit in many locations is providing mobility for
those who cannot otherwise drive themselves, such that they have some
accessibility to activities and services beyond walking distance
\citep{Currie:2016aa}. Age, disability, socio-economic status, lack of a
vehicle or many other factors might make someone reliant on transit for
some or all of their travel. Vertical social-equity perspectives on
transport policy-making, relate to supporting those who are
disadvantaged \citep{Litman:2016aa}. These might suggest providing at
least some transit, and probably more than just a minimum, where there
are higher social needs for transport. As well, lower proportions of
younger people are obtaining a driving license than was the case
previously \citep{delbosc2013causes}, suggesting an increased need for
...
spatial analysis technique. As well, it is unclear whether the
identified patterns have changed in the intervening years.
...
transit-related outputs for any place publishing a feed. aHowever, tools
...
consistent with the current situation. This paper reportes the
...
(\(\chi^2(12, N = 18489) = 87.45\), \(p < .001\)). Differences are also
...
Only 81 CCDs (1.3\%) have Zero Supply in 2021, compared to the 189
(3.2\%) reported by \citet{currie2010identifying} for 2006. These shares
by CCDs, however, are only for 2006 extents of Melbourne. The ABS'
...
Again, the difference between the share of areas of interest in each
category in 2006 (CCDs), 2016 and 2021 (SA1s) is statistically
significant (\(\chi^2(12, N = 27615) = 58.86\), \(p < .001\)), but not
between 2006 and 2016 (as a pair, \(\chi^2(6, N = 16128) = 8.83\),
\(p = .183\)). The differences between 2006 and 2021 are statistically
significant (\(\chi^2(6, N = 17326) = 44.83\), \(p < .001\)) as are the
differences between 2016 and 2021 \(\chi^2(6, N = 21776) = 31.56\),
\(p < .001\)). There is a greater proportion of SA1s with Zero Supply in
2021 (4.3\%) than there were CCDs in 2006 (3.25\%) or SA1s in 2016
(3.2\%). The share of SA1s with supply below the average SI score
...
(2.5\%) in 2006 to 186,829 (3.8\%) in 2021. Residents with Zero or Very
Low Transport Supply rose by 50\% from 878,469 (26.1\%) in 2006 to
1,319,796 (26.8\%) in 2021. Residents with supply below the average
(Zero, Very Low, Low or Below Average) rose by 45\% from 2,518,320
...
(from 131,619 (2.9\%)). The number\\
Residents with Zero or Very Low Transport Supply rose by 16\% (from
1,140,117 (25.4\%)) Residents with supply below the average (Zero, Very
Low, Low or Below Average) rose 15\% (from 3,157,255 (70.4\%)).
...
than the average supply in outer areas of Greater Melbourne\footnote{The
  ...
  Peninsula SA4 zones}. Table
\ref{tab:Greater_Melbourne_population_2016_by_SA4} and Table
...
2016 and 2021 respectively\footnote{SA4s are the largest of the
  ...
  at the extreme south of the Melbourne GCCSA).}. In 2016, 2,714,128
...
(+12\%), 3,409.1 (+27\%) and 998.96 (+31\%) respectively\footnote{The
  same grouping of Local Government Areas (LGAs) to inner, middle and
  outer suburb groups as used in \citet{currie2010identifying} was used
  for this analysis, although here the City of Stonnington was allocated
  entirely to the middle grouping, whereas \citet{currie2010identifying}
  allocated part of this LGA to the inner group.}. Results found here
might not be exactly comparable to those in
\citet{currie2010identifying} due to geographic
inconsistencies\footnote{However, the \citet{currie2010identifying}
...
SI scores between 2016 and 2021. Average SI scores for SA1s across all
of Greater Melbourne increased from 2,843.8 (2016) to 2,901.4 (2021,
+2.0\%). There is a statistically significant and strong correlation
between the 2016 and 2021 SI scores (\(r(11485) = 1.00\), \(p < .001\),
\(r_s =.98\), \(p < .001\)). There is also a statistically significant
difference in the proportion of SA1s in each service level change
category across SA4 areas (\(\chi^2(88) = 2829.67\),
\(p < .001\))\footnote{See Appendix for table}.
...
Melbourne as a whole (column 11). In 2021, slightly more than half of
the population across Greater Melbourne were living in SA1s where the SI
scores were at least one percent higher than they were in 2016
(2,517,945 people, 51.2\%). The share of population for whom the SI
increased by at least one percent was highest in the North-West (305,443
people, 72.0\%) and West (581,781 people, 68.2\%) SA4s, but lowest in
the Inner East (108,918 people, 29.2\%) and Outer East (116,804 people,
22.5\%) SA4s.

Service levels in 2021 stayed within one percent of the level in 2016
for 1,393,581 people across Greater Melbourne (28.3\%). The share of
population for whom the SI stayed within one percent was highest in the
Outer East (274,423 people, 52.9\%) and Inner East (187,974 people,
50.3\%).

Across all of Greater Melbourne 825,124 people, 16.8\%) were living in
SA1s in 2021 where the SI was more than one percent lower than it had
been in 2016. The share of the population living in areas where the SI
had dropped by more than one percent was largest in the Inner (174,615
people, 28.3\%), Inner South (100,869 people, 23.9\%) and Outer East
(114,281 people, 22.0\%) SA4s.

Across all of Greater Melbourne 180,983 residents in 2021 (3.7\%) were
living in SA1s that did not have transit service and had not had service
in 2016 either. The share of the population without transit in either
2016 or 2021 was highest amongst the Mornington Peninsula (7.8\%,
...
\subsection{Problem here! Graph does not match
table}\label{problem-here-graph-does-not-match-table}
...
\begin{verbatim}
## geom_scale_bar: plot_unit = NULL, bar_cols = c("black", "white"), line_width = 1, height = 0.25, pad_x = 0.25, pad_y = 0.25, text_pad = 0.15, text_cex = 0.7, text_face = NULL, text_family = , tick_height = 0.6
