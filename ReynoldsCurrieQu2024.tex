...
Campus},city={Melbourne},postcode={3800},state={Victoria},country={Australia},}
  ...
  \begin{abstract}
  Transit often provides an vital social purpose, linking those who
  cannot otherwise drive to services, activities and community. Vertical
  social equity perspecties on transport policy emphasise providing
  services to those most in need. In previous research Currie and
  Senbergs (2007) and Currie (2010) developed an analysis approach for
  identifying spatial areas where gaps between transit supply,
  accounting for frequency and coverage, and transport needs are larger.
  However, this approach does not appear to have been widely adopted or
  received further research attention. This may be due to the challenges
  associated with assessing transit supply levels prior to the
  widespread avaialbility of schedule data in electronic formats.
  Nowadays, GTFS datasets are provided by many operators, allowing the
  development of standardised processing tools. Such a tool, though,
  does not yet appears to be available for needs-gap analysis, nor does
  it appear that there has been further review of spatial patterns since
  the Currie and Senbergs (2007) and Currie (2010) case study of
  Melbourne in 2006. This paper reportes the development of a software
  package with tools for using GTFS dataset for needs-gap analysi,
  available for the R statistiacal analysis language. The paper also
  reports results for Melbourne in 2016 and 2021, both tot demostrate
  the package capabilities and continue the previous research as a
  longitudinal case study.\\
  Results indicate similar patterns of social need and transit supply as
  in 2006, with lower supply levels in outer areas, particularly those
  that are away from the suburban rail network. The share of residents
  living in areas with Very High needs but Very Low or Zero transit
  supply, however, has increased from 8.2\% of the population in 2006 to
  11.2\% in 2016 and ?? in 2021. The paper also briefly revists a case
  study of early-2010s development in the outer south east reported in
  Delbosc et al (2015), finding that there have been positive changes in
  service level at this local scale, but needs-gaps for parts of the
  neighbourhood are amongst the highest in Greater Melbourne. While
  Melbourne may be an outlier in terms of high population growth (3.4m
  to 4.9m in 15 years) at generally low densities, compared to other
  cities, theses result might suggest that providing even a basic level
  of transit-based movility to those in need has only become more
  difficult. Direction for further research and limitations are also
  identified.
  \end{abstract}
    \begin{keyword}
    social needs \sep public transport \sep transit \sep spatial
analysis \sep 
    GTFS
  \end{keyword}
...
{\centering \subfloat[Bus Route 798 as originally introduced in 2014 (Source: Delbosc et al (2015))\label{fig:Bus_798-1}]{\includegraphics[width=0.5\linewidth]{graphics/Cranbourne2014} }\subfloat[Surrounding transit routes in 2018\label{fig:Bus_798-2}]{\includegraphics[width=0.5\linewidth]{graphics/Cranbourne2018} }\newline\subfloat[Surrounding transit routes in 2021\label{fig:Bus_798-3}]{\includegraphics[width=0.5\linewidth]{graphics/Cranbourne2021} }\subfloat[Surrounding transit routes in 2024 (Source: PTV)\label{fig:Bus_798-4}]{\includegraphics[width=0.5\linewidth]{graphics/Cranbourne2024} }\newline
...
{\centering \subfloat[Transport Supply by SA1: 2016\label{fig:Selandra_rise-1}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-1} }\subfloat[Transport Supply by population: 2016\label{fig:Selandra_rise-2}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-2} }\newline\subfloat[Transport Supply by SA1: 2021\label{fig:Selandra_rise-3}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-3} }\subfloat[Transport Supply by population: 2021\label{fig:Selandra_rise-4}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-4} }\newline\subfloat[Change in SI score 2016 to 2021, by SA1\label{fig:Selandra_rise-5}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-5} }\subfloat[Change in SI score 2016 to 2021, by 2021 population\label{fig:Selandra_rise-6}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-6} }\newline\subfloat[Social Need by SA1: 2021\label{fig:Selandra_rise-7}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-7} }\subfloat[Social Need by population: 2021\label{fig:Selandra_rise-8}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-8} }\newline\subfloat[Needs-gap: SA1s with Very High needs 2021, by supply\label{fig:Selandra_rise-9}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-9} }\subfloat[Needs-gap: population with Very High 2021, by supply\label{fig:Selandra_rise-10}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-10} }\newline

}

\caption{Cranbourne and the Selandra Rise Estate, overlayed with transit routes (purple)}\label{fig:Selandra_rise}
\end{figure}

Various transit routes have been added to the area surrounding the
...
{\centering \subfloat[Week starting the date of the 2016 census\label{fig:Greater_Melbourne_CCD_2016_appendix-1}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Greater_Melbourne_CCD_2016_appendix-1} }\subfloat[Week starting the date of the 2021 census\label{fig:Greater_Melbourne_CCD_2016_appendix-2}]{\includegraphics{ReynoldsCurrieQu2024_files/figure-latex/Greater_Melbourne_CCD_2016_appendix-2} }
