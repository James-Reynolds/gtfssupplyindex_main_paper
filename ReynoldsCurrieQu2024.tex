...
\ref{fig:north_east_changes} highlights the two SA1s in which these
people live, which are north-west of Epping, in the vicinity of Harvest
Home Road.

\begin{figure}

{\centering \subfloat[a) Transport Supply categories in 2016\label{fig:north_east_changes-1}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/north_east_changes-1} }\subfloat[b) Transport Supply categories in 2021\label{fig:north_east_changes-2}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/north_east_changes-2} }\newline\subfloat[c) Change in SI score between 2016 and 2021 for SA1s with Very High needs but Very Low or Zero supply with population in 2021\label{fig:north_east_changes-3}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/north_east_changes-3} }\subfloat[d) Current (2024) route map\label{fig:north_east_changes-4}]{\includegraphics[width=0.5\linewidth]{graphics/Epping} }\newline

}

\caption{Part of the North East SA4 region (centred on Epping North), overlayed with transit routes (purple)}\label{fig:north_east_changes}
\end{figure}

Figure \ref{fig:north_east_changes} shows the Transport Supply
categories transit routes in 2016 (top-left) and 2021 (top-right). There
appears to have been a rerouting and, as shown in the current (2024)
transit map for the area (Figure \ref{fig:north_east_changes},
bottom-right) the 357 bus route no longer extends north-west along
Eaststone Avenue. This results in the 674 and 641 people living in two
SA1s more than 400m west of Edgars Road no longer having a bus stop
within the buffer zone, and a withdrawal of service (Figure
\ref{fig:north_east_changes}, bottom-left) as per the definitions used
here. The analysis presented here might provide support for a resumption
of service on Eaststone Avenue, although further housing development is
underway in this area and transit services appear likely to change
further. Indeed, the Route 390 shown in (Figure
\ref{fig:north_east_changes}, bottom-right) appears to have been
recently introduced\footnote{https://www.ptv.vic.gov.au/route/15643/309-city-the-pines-sc-via-eastern-fwy-and-reynolds-rd/}.
...
estate in the south-east of Melbourne\footnote{This study explored the
  impact of the, then newly introduced, 798 bus route. The route was
  reported as having around 2,500 boardings per week and being used by
  at least one person in 35 percent of households within the Selandra
  Rise Estate, despite it not penetrating fully into the development and
  only 20 percent of the estate's footprint being within 400 metres of
  the route.}. Findings suggested that: the route was ``performing an
...
lifts'' \citep[p.10]{delbosc2015impact}. Figure \ref{fig:Selandra_rise}
revisits the Selandra Rise Estate, showing transport supply in 2016 and
2021, and changes in SI score for SA1s with Very High social needs, but
Very Low or Zero transit supply.

\begin{figure}

{\centering \subfloat[a) Bus Route 798 as originally introduced in 2014 (Source: Delbosc et al (2015))\label{fig:Selandra_rise-1}]{\includegraphics[width=0.5\linewidth]{graphics/Route798} }\subfloat[b) Transport Supply categories in 2016 (transit routes in purple)\label{fig:Selandra_rise-2}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-2} }\newline\subfloat[c) Transport Supply categories in 2021 (transit routes in purple)\label{fig:Selandra_rise-3}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-3} }\subfloat[d) Change in SI score between 2016 and 2021 for SA1s with Very High needs but Very Low or Zero supply with 2021 populations (transit routes in purple)\label{fig:Selandra_rise-4}]{\includegraphics[width=0.5\linewidth]{ReynoldsCurrieQu2024_files/figure-latex/Selandra_rise-4} }\newline\subfloat[e) Current (2024) route map\label{fig:Selandra_rise-5}]{\includegraphics[width=0.5\linewidth]{graphics/Cranbourne} }
...
neighbourhood (Figures \ref{fig:north_east_changes} and
\ref{fig:Selandra_rise}) might be of use to transport planners,
advocates, politicians and other decision-makers, and others seeking to
build legitimacy for the improvement or introduction of basic transit
service levels. It is heartening that the Selandra Rise Estate, where
\citet{delbosc2015impact} found that what transit was initially
implemented provide a very important social function and that there was
a community desire for greater levels of service, now has more routes
and higher service levels. However, Figure \ref{fig:Selandra_rise} shows
that there were similarly under-or-never-served communities nearby in
2021, suggesting that the timely introduction of transit service to new
development areas continues to be a challenge in parts of Melbourne.
Further research might seek to confirm whether similar issues are
evident in outer and new development areas of other cities, although
this would seem likely to be the case in many other places.
