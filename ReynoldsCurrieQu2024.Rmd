...
These values, however, are only for CCDs within the 2006 extents of Melbourne. The ABS' statistical boundary of "Greater Melbourne" now includes areas up to around 30 kilometers further to the north, as shown in the 2021 map in Figure \ref{fig:Greater_Melbourne_CCDs_SA1_population}. This shows that the new parts of Melbourne, beyond the 2006 statistical boundary, mostly have Very Low or Zero Transport Supply levels. Again, the differences between 2006 (CCDs), 2016 and 2021 (SA1s) are statistically significant (`r prmisc::print_chi2(melbourne_comparison_2006_2021 %>% select(ccds_2006, sa1s_2016, sa1s_2021) %>% as.matrix())`), but not between 2006 and 2016 (as a pair, `r prmisc::print_chi2(melbourne_comparison_2006_2021 %>% select(ccds_2006, sa1s_2016) %>% as.matrix())`). The differences between 2006 and 2021 are statistically significant (`r prmisc::print_chi2(melbourne_comparison_2006_2021 %>% select(ccds_2006, sa1s_2021) %>% as.matrix())`) as are the differences between 2016 and 2021 `r prmisc::print_chi2(melbourne_comparison_2006_2021 %>% select(sa1s_2016, sa1s_2021) %>% as.matrix())`). There are a greater proportion of SA1s with Zero Supply in 2021 (`r percent_format(accuracy = 0.1)((melbourne_si_SA12021_21_census_week_aggregated[["si_by_area"]] %>%  filter(transit_supply == "Zero Supply") %>% nrow()/melbourne_si_SA12021_21_census_week_aggregated[["si_by_area"]] %>% nrow()))`) than there were CCDs in 2006 (3.25%) or SA1s in 2016 (`r percent_format(accuracy = 0.1)((melbourne_si_SA12016_16_census_week_aggregated[["si_by_area"]] %>%  filter(transit_supply == "Zero Supply") %>% nrow()/melbourne_si_SA12016_16_census_week_aggregated[["si_by_area"]] %>% nrow()))`). The share of SA1s with supply below the average SI score (i.e. Zero, Very Low, Low or Below Average) is also larger in 2021 (`r percent_format(accuracy = 0.1)(1-(melbourne_si_SA12021_21_census_week_aggregated[["si_by_area"]] %>%  filter(transit_supply == "Very High" | transit_supply == "High" | transit_supply == "Above average")) %>% nrow()/melbourne_si_SA12021_21_census_week_aggregated[["si_by_area"]] %>% nrow())`) compared to the share of CCDs in 2006 (70.3%) or share of SA1s in 2016 (`r percent_format(accuracy = 0.1)(1-(melbourne_si_SA12016_16_census_week_aggregated[["si_by_area"]] %>%  filter(transit_supply == "Very High" | transit_supply == "High" | transit_supply == "Above average")) %>% nrow()/melbourne_si_SA12016_16_census_week_aggregated[["si_by_area"]] %>% nrow())`)
...
Differences are statistically significant across all three periods 
(2006, 2016 and 2021 
`r prmisc::print_chi2(melbourne_comparison_2006_2021 %>% select(population_2006, population_2016, population_2021) %>% as.matrix())`),
between 2006 and 2016 
(`r prmisc::print_chi2(melbourne_comparison_2006_2021 %>% select(population_2006, population_2016) %>% as.matrix())`), 
and between 2006 and 2021 (`r prmisc::print_chi2(melbourne_comparison_2006_2021 %>% select(population_2006, population_2021) %>% as.matrix())`). 
The number of people with zero supply rose from `r format(sum(melbourne_comparison_2006_2021[1,3]), big.mark = ",")` 
...
This represents a 
`r label_percent(accuracy=0.1)(sum(melbourne_comparison_2006_2021[1,9])/sum(melbourne_comparison_2006_2021[1,3])-1)` 
increase, compared to the population increase of only 
`r label_percent(accuracy=0.1)(sum(melbourne_comparison_2006_2021[,9])/sum(melbourne_comparison_2006_2021[,3])-1)` 
...
in 2021. 
This represents a 
`r label_percent(accuracy=0.1)(sum(melbourne_comparison_2006_2021[1:2,9])/sum(melbourne_comparison_2006_2021[1:2,3])-1)` 
increase 
(`r label_percent(accuracy=0.1)(sum(melbourne_comparison_2006_2021[1:2,9])/sum(melbourne_comparison_2006_2021[1:2,3]) - sum(melbourne_comparison_2006_2021[,9])/sum(melbourne_comparison_2006_2021[,3]))`
...
This represents a 
`r label_percent(accuracy=0.1)(sum(melbourne_comparison_2006_2021[1:4,9])/sum(melbourne_comparison_2006_2021[1:4,3])-1)` increase, which is 
`r label_percent(accuracy=0.1)(-1*(sum(melbourne_comparison_2006_2021[1:4,9])/sum(melbourne_comparison_2006_2021[1:4,3]) - sum(melbourne_comparison_2006_2021[,9])/sum(melbourne_comparison_2006_2021[,3])))` 
lower than the population change.

Differences were also statistically significant between 2016 and 2021 
(`r prmisc::print_chi2(melbourne_comparison_2006_2021 %>% select(population_2016, population_2021) %>% as.matrix())`). 
...
for areas smaller than Greater Capital Cities or other agglomerations.]. 
...
```
 ...
 The average SI value in 2021 (using CCDs and within the 2006 boundary) was 
 `r si_CCD2006_21_census_week_aggregated[["si_by_area"]] %>% select(SI) %>% st_drop_geometry() %>% unlist()%>% mean() %>% format(big.mark = ",", digits = 5)`. 
 SI scores average 
 `r si_CCD2006_21_census_week_aggregated$si_by_area %>% st_drop_geometry() %>% filter(suburbs == "inner") %>% select(SI) %>% unlist() %>% mean() %>% format(big.mark = ",", digits = 6)`, `r si_CCD2006_21_census_week_aggregated$si_by_area %>% st_drop_geometry() %>% filter(suburbs == "middle") %>% select(SI) %>% unlist() %>% mean() %>% format(big.mark = ",", digits = 5)` and 
...
in 2021 for the CCDs in the inner, middle and outer suburbs 
respectively^[The same grouping of LGAs to inner, middle and outer suburb groups 
...
compared to 10,922.7, 2,694.9 and 764.3, respectively, 
reported for 2006 in @currie2010identifying. 
...
although overall results appear to be consistent 
...
in inner and then middle suburbs remaining unchanged. 
...
There is a statistically significant difference in the distribution of service level changes across the populations between SA4 areas (`r prmisc::print_chi2(greater_melbourne_ratio_population_wider %>% select(Inner, "Inner East", "Inner South", "North East", "North West", "Outer East", "South East", "West", "Mornington Peninsula")  %>% as.matrix())`). In 2021, more than half of the SA4 population were living in SA1s where the SI scores were more than one percent higher than in 2016 in the North-West (`r greater_melbourne_ratio_population_wider[2:7,5] %>% sum() %>% format(big.mark = ",")` people, `r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[2:7,5] %>% sum() / greater_melbourne_ratio_population_wider[,5] %>% sum())`), West (`r greater_melbourne_ratio_population_wider[2:7,8] %>% sum() %>% format(big.mark = ",")` people, `r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[2:7,8] %>% sum() / greater_melbourne_ratio_population_wider[,8] %>% sum())`), North East (`r greater_melbourne_ratio_population_wider[2:7,4] %>% sum() %>% format(big.mark = ",")` people, `r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[2:7,4] %>% sum() / greater_melbourne_ratio_population_wider[,4] %>% sum())`), South East (`r greater_melbourne_ratio_population_wider[2:7,7] %>% sum() %>% format(big.mark = ",")` people, `r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[2:7,7] %>% sum() / greater_melbourne_ratio_population_wider[,8] %>% sum())`), Mornington Peninsula (`r greater_melbourne_ratio_population_wider[2:7,9] %>% sum() %>% format(big.mark = ",")` people, `r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[2:7,9] %>% sum() / greater_melbourne_ratio_population_wider[,9] %>% sum())`) and Inner (`r greater_melbourne_ratio_population_wider[2:7,10] %>% sum() %>% format(big.mark = ",")` people, `r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[2:7,10] %>% sum() / greater_melbourne_ratio_population_wider[,10] %>% sum())`) SA4s 


Service levels in 2021 were within one percent of the level in 2016 for most of the population in the Outer East (`r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[7,4] %>% sum() /sum(greater_melbourne_ratio_population_wider[,4]))`) and Inner East (`r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[7,9] %>% as.numeric() /sum(greater_melbourne_ratio_population_wider[,9]))`), compared to only `r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[7,2:10] %>% sum() /sum(greater_melbourne_ratio_population_wider[,2:10]))` of the population across all of Greater Melbourne. The largest shares of the overall population living in areas (across Greater Melbourne) were service levels remained within one percent were in the Outer East (`r greater_melbourne_ratio_population_wider[7,6] %>% as.numeric() %>% format(big.mark = ",")` people, `r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[7,6] %>% as.numeric() / greater_melbourne_ratio_population_wider[7,2:10] %>% as.numeric() %>% sum())` of the `r greater_melbourne_ratio_population_wider[7,2:10] %>% as.numeric() %>% sum() %>% format(big.mark = ",")`), South East (`r greater_melbourne_ratio_population_wider[7,5] %>% as.numeric() %>% format(big.mark = ",")` people, `r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[7,5] %>% as.numeric() / greater_melbourne_ratio_population_wider[7,2:10] %>% sum())`) and Inner East (`r greater_melbourne_ratio_population_wider[7,9] %>% as.numeric() %>% format(big.mark = ",")` people, `r label_percent(accuracy = 0.1)(greater_melbourne_ratio_population_wider[7,9] %>% as.numeric() / greater_melbourne_ratio_population_wider[7,2:10] %>% sum())`).



In 2021, the share of the population living in SA1s where the SI was more than one percent lower than in 2016 was largest in the Inner (`r label_percent(accuracy = 0.1)(sum(greater_melbourne_ratio_population_wider[8:11,8]) /sum(greater_melbourne_ratio_population_wider[,8]))`), Inner South (`r label_percent(accuracy = 0.1)(sum(greater_melbourne_ratio_population_wider[8:11,10]) /sum(greater_melbourne_ratio_population_wider[,10]))`) and Outer East (`r label_percent(accuracy = 0.1)(sum(greater_melbourne_ratio_population_wider[8:11,6]) /sum(greater_melbourne_ratio_population_wider[,6]))`) SA4s. The largest shares of residents with at less one percent lower service level in 2021 were among the Inner (`r sum(greater_melbourne_ratio_population_wider[8:11,8]) %>% format(big.mark = ",")`), Outer East (`r sum(greater_melbourne_ratio_population_wider[8:11,4]) %>% format(big.mark = ",")`) and South East (`r sum(greater_melbourne_ratio_population_wider[8:11,5]) %>% format(big.mark = ",")`) SA4 areas.   
...
```{r Greater_Melbourne_2021_needs_gap_scatterplot_figure, fig.show="hold", eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.fullwidth = TRUE, fig.height=8, fig.cap="Greater Melbourne 2021, SI and Combined Needs Index scores, with SI scores < 10 rounded up to equal 10. "}
...
pcol_vhigh_vlow_zero <- melbourne_needs_gap_sa1_2016  %>%
  ...
  guides(fill = "none", color = "none") +
  labs(
    title = "Very High Needs population by Transit Supply",
    x = NULL,
    y = NULL
  ) +
  theme_void() +
...
pcol <- melbourne_needs_gap_sa1_2016  %>%
  ...
  guides(fill = "none", color = "none") +
  labs(
    title = "Rest of population by Transit Supply",
    x = NULL,
    y = NULL
  ) +
  theme_void() +
...
pcol_vhigh_vlow_zero <- melbourne_needs_gap_sa1_2021  %>%
  ...
  geom_col(aes(transit_supply, population, fill = transit_supply)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 20000, label = glue::glue("{label_percent(accuracy = 0.1)(perc)}")), size = 2) +
  coord_flip() +
  scale_fill_manual(values = c("red", "red", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
