...
```{r Greater_Melbourne_2016_2021_ratio_map_plot, fig.show="hold", fig.dim=c(7.5,7.5),  echo = FALSE, warning=FALSE, message=FALSE, cache = FALSE, include = TRUE, fig.cap="Greater Melbourne: changes in SI between 2016 and 2021, by 2021 SA1, overlayed with 2006 Greater Melbourne boundary (black); 2021 SA4 boundaries (blue); and suburban railway lines (black)"}
 ...
 ggplot()+ 
  ...
  inset_element(pcol_outer_east, left = 0.75, bottom = 0.85, right = 1.05, top =1) +
  ...
  inset_element(pcol_inner_south, left = 0.33, bottom = 0.18, right = 0.63, top =0.33) + inset_element(pcol_inner_east, left = 0.75, bottom = 0.7, right = 1.05, top =0.85)  
...
inset_element(pcol, left = 0.0, bottom = 0.0, right = 0.4, top =0.30) +
  ...
  inset_element(pcol_north_west, left = 0.0, bottom = 0.81, right = 0.3, top =0.96) +
  inset_element(pcol_west, left = 0.00, bottom = 0.30, right = 0.3, top =0.45) +
  inset_element(pcol_inner, left = 0.3, bottom = 0.25, right = 0.6, top =0.4) +
  inset_element(pcol_inner_south, left = 0.3, bottom = 0.1, right = 0.6, top =0.25) +  inset_element(pcol_inner_east, left = 0.75, bottom = 0.78, right = 1.05, top =0.93) 
...
pcol_mornington <- left_join(data.frame(ratio_binned_collapsed=levels(si_by_areaSA12016_2016_2021_wider$ratio_binned_collapsed)),
 ...
 Greater_MelbourneSA12016_2016_2021_ratio_map +
  ...
  inset_element(pcol_south_east, left = 0.72, bottom = 0.03, right = 1.02, top =0.17) +
  inset_element(pcol_outer_east, left = 0.72, bottom = 0.70, right = 1.02, top =0.85) +
...
#        legend.key.size = unit(0.08, 'cm')
   ...
   scale_fill_manual(values = c("darkblue", "blue", "#F7C387", "#F29C33", "lightgreen", "#53A212", "darkgreen")) + 
  geom_sf(data=sa4_boundaries, fill = NA, colour="blue") +
  geom_sf(data=melbourne_sd07aust_region, 
          colour="black", 
          fill=NA) +
