...
```{r Bus_798, fig.show="hold", eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.ncol = 2, fig.width = 3.8, fig.align = "center", fig.show="hold",  fig.cap="Cranbourne and Selandra Rise", fig.subcap=c("Transit routes: 2014 (Source: Delbosc et al (2015) overlaid on PTV(2014))", "Transit routes: 2021 (Source: PTV(2021))")}
...
geom_sf(data=melbourne_sd07aust_region, 
 ...
 data = si_by_areaSA12016_2016_2021_wider %>% 
  ...
  theme(axis.text=element_blank(),
        ...
        plot.title = element_blank(),
        text = element_text(size = 2, hjust = 1),
        legend.position="none")
