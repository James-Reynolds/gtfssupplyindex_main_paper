...
inset_element(pcol, left = 0.0, bottom = 0.0, right = 0.40, top =0.30) +
  ...
  inset_element(pcol_outer_east, left = 0.85, bottom = 0.686, right = 1.15, top =0.83) +
  inset_element(pcol_north_east, left = 0.6, bottom = 0.80, right = 0.9, top =0.95)  +
  inset_element(pcol_north_west, left = 0.05, bottom = 0.81, right = 0.35, top =0.96) +
  inset_element(pcol_west, left = 0.03, bottom = 0.32, right = 0.33, top =0.47) +
  inset_element(pcol_inner, left = 0.2, bottom = 0.32, right = 0.5, top =0.47) +
...
Greater_Melbourne_2016_2021_ratio_map +
  ggspatial::annotation_scale(location = 'br') + 
  ggspatial::annotation_north_arrow(location = 'tr') + 
  inset_element(pcol, left = 0.0, bottom = 0.0, right = 0.48, top =0.4) +
  inset_element(pcol_mornington, left = 0.58, bottom = 0.05, right = 0.88, top =0.2) +
  inset_element(pcol_south_east, left = 0.8, bottom = 0.05, right = 1.1, top =0.20) +
  inset_element(pcol_outer_east, left = 0.7, bottom = 0.83, right = 1.0, top =0.98) +
  inset_element(pcol_north_east, left = 0.53, bottom = 0.83, right = 0.83, top =0.98)  +
  inset_element(pcol_north_west, left = 0.0, bottom = 0.80, right = 0.3, top =0.95) +
  inset_element(pcol_west, left = 0.0, bottom = 0.5, right = 0.3, top =0.65) +
  inset_element(pcol_inner, left = 0.32, bottom = 0.32, right = 0.62, top =0.47) +
  inset_element(pcol_inner_south, left = 0.32, bottom = 0.16, right = 0.62, top =0.31) +
  inset_element(pcol_inner_east, left = 0.7, bottom = 0.67, right = 1, top =0.82)  
...
pcol <- combined_needs_index_2021_sa1_greater_melbourne_sa4 %>%
  ...
  geom_hline(yintercept = 0)  + 
  geom_text(aes(composite_needs, perc+0.03, label = glue::glue("{label_percent(accuracy = 1)(perc)}")), size = 2) +
  coord_flip() + 
    scale_fill_manual(values = c("#FFFB07", "#CEE102", "#A3CF07", "#61AE09", "#2EA105", "#0A7B01")) + 
 guides(fill = "none", color = "none") +
  labs(
...
combined_needs_2021_plot +
  ...
  inset_element(pcol_outer_east, left = 0.8, bottom = 0.686, right = 1.1, top =0.83) +
  inset_element(pcol_north_east, left = 0.6, bottom = 0.85, right = 0.9, top =1.0)  +
  inset_element(pcol_north_west, left = 0.0, bottom = 0.81, right = 0.3, top =0.96) +
  inset_element(pcol_west, left = 0.0, bottom = 0.3, right = 0.3, top =0.45) +
  inset_element(pcol_inner, left = 0.25, bottom = 0.30, right = 0.55, top =0.45) +
  inset_element(pcol_inner_south, left = 0.25, bottom = 0.15, right = 0.55, top =0.30) +
  inset_element(pcol_inner_east, left = 0.25, bottom = 0.85, right = 0.55, top =1) 
...
#        legend.key.size = unit(0.08, 'cm')
  ...
  ggspatial::annotation_north_arrow(location = 'tr') +
inset_element(pcol, left = 0.0, bottom = 0.0, right = 0.45, top =0.31) +
  inset_element(pcol_mornington, left = 0.6, bottom = 0.03, right = 0.9, top =0.18) +
  inset_element(pcol_south_east, left = 0.8, bottom = 0.03, right = 1.1, top =0.18) +
  inset_element(pcol_outer_east, left = 0.80, bottom = 0.69, right = 1.05, top =0.84) +
  inset_element(pcol_north_east, left = 0.58, bottom = 0.85, right = 0.88, top =1.0)  +
  inset_element(pcol_north_west, left = 0.05, bottom = 0.81, right = 0.35, top =0.96) +
  inset_element(pcol_west, left = 0.0, bottom = 0.31, right = 0.3, top =0.46) +
  inset_element(pcol_inner, left = 0.20, bottom = 0.31, right = 0.45, top =0.46) +
  inset_element(pcol_inner_south, left = 0.30, bottom = 0.2, right = 0.60, top =0.35) +
  inset_element(pcol_inner_east, left = 0.80, bottom = 0.5, right = 1.1, top =0.65) 
...
```{r route_maps, fig.show="hold", eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.ncol = 2, out.width = "50%", fig.align = "center", fig.show="hold", fig.cap="Cranbourne and the Selandra Rise Estate (2021 SA1 boundaries)", fig.subcap = c( "Transport Supply categories in 2016", "Transport Supply categories in 2021", "Social Need categories in 2021", "Very High Social Needs: Transport Supply categories in 2021", "Change in SI score between 2016 and 2021", "Very High Social Needs, Very Low or Zero Supply (2021): Change in SI score between 2016 and 2021")}
...
```{r Selandra_rise, fig.show="hold", eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.ncol = 2, out.width = "50%", fig.align = "center", fig.show="hold", fig.cap="Cranbourne and the Selandra Rise Estate (2021 SA1 boundaries)", fig.subcap = c( "Transport Supply categories in 2016", "Transport Supply categories in 2021", "Change in SI score between 2016 and 2021", "Social Need categories in 2021", "Change in transit supply between 2016 and 2021 for SA1s with Very High needs but Very Low or Zero supply in 2016", "Needs-gap: SA1s with Very High transport need areas by Transport Supply")}
...
pcol <- melbourne_si_SA12016_16_census_week_aggregated$si_by_area %>%
  ...
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 15000, label = glue::glue("{label_comma(accuracy = 1, big.mark = ",")(population)} ({label_percent(accuracy = 1)(perc)})")), size = 3.5) +
  coord_flip() + 
 scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
#        legend.key.size = unit(0.08, 'cm')
  ...
  ggspatial::annotation_north_arrow(location = 'tr') +
  inset_element(pcol, left = 0.5, bottom = 0.0, right = 1.1, top = 0.35)
...
pcol <- melbourne_si_SA12021_21_census_week_aggregated$si_by_area %>%
  ...
  scale_y_continuous(limits = c(0,80000)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 20000, label = glue::glue("{label_comma(accuracy = 1, big.mark = ",")(population)} ({label_percent(accuracy = 1)(perc)})")), size = 3.5) +
  coord_flip() + 
 scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
pcol <- si_by_area_2016_2021_wider %>%
 ...
 geom_col(aes(ratio_binned, perc, fill = ratio_binned), colour="black") +
  scale_y_continuous(limits = c(0,0.7)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(ratio_binned, perc+0.1, label = glue::glue("{label_percent(accuracy = 1)(perc)}")), size = 3.5) +
  coord_flip() +
  scale_fill_manual(values = c("#3A65A3", "#6D9DC4", "#A6CFE1", "#DDEFF5", "#FFFBB5", "#F9D785", "#EFA15C", "#DC6446", "#BA3832", "#852128", "magenta", "black")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
 ...
 title = "Population share",
  ...
  theme(
    ...
    axis.text.y = element_text(size = 10, hjust = 1, colour = "white"),
    axis.text.x = element_blank())
...
ggplot()+ 
  ...
  geom_sf(data=sa4_boundaries, fill = NA, colour="blue") + 
   coord_sf(ylim = c(-38.082, -38.128), 
           xlim = c(145.25, 145.360)) +
  inset_element(pcol, left = 0.0, bottom = 0.5, right = 1.1, top = 0.5)
...
pcol <- combined_needs_index_2021_sa1_greater_melbourne %>%
 ...
 geom_col(aes(composite_needs, perc, fill = composite_needs), colour="black") +
  scale_y_continuous(limits = c(0,0.7)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(composite_needs, perc+0.05, label = glue::glue("{label_percent(accuracy = 1)(perc)}")), size = 3.5) +
  coord_flip() +
  scale_fill_manual(values = c("#FFFB07", "#CEE102", "#A3CF07", "#61AE09", "#2EA105", "#0A7B01")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
ggplot()+ 
  ...
  coord_sf(ylim = c(-38.082, -38.128), 
           xlim = c(145.25, 145.360)) +
  inset_element(pcol, left = 0.7, bottom = 0.0, right = 1.2, top = 0.35)
...
#ggplot()+ 
#  geom_sf(data=melbourne_needs_gap_sa1_2016 %>% 
#          filter(composite_needs == "Very High"),
#          aes(fill = transit_supply), colour=NA) +
#  theme(axis.text.x=element_blank(), #remove x axis labels
#        axis.ticks.x=element_blank(), #remove x axis ticks
...
pcol <- si_by_areaSA12016_2016_2021_wider %>% 
 ...
 geom_col(aes(ratio_binned_collapsed, perc, fill = ratio_binned_collapsed), colour="black") +
  scale_y_continuous(limits = c(0,0.7)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(ratio_binned_collapsed, perc+0.05, label = glue::glue("{label_percent(accuracy = 1)(perc)}")), size = 3.5) +
  coord_flip() +
  scale_fill_manual(values = c("#3A65A3", "#C2DFEB", "#EFA15C", "#BA3832", "black")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
pcol <- melbourne_needs_gap_sa1_2021 %>% 
 ...
 geom_col(aes(transit_supply, perc, fill = transit_supply), colour="black") +
  scale_y_continuous(limits = c(0,0.7)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, perc+0.05, label = glue::glue("{label_percent(accuracy = 1)(perc)}")), size = 3.5) +
  coord_flip() +
  scale_fill_manual(values = c("darkred", "red", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) + 
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
#        legend.key.size = unit(0.08, 'cm')
  ...
  geom_sf(data=melbourne_railway_trips_shape_2021, linetype = "twodash", size = 0.1) + 
    coord_sf(ylim = c(-38.082, -38.128), 
           xlim = c(145.25, 145.360)) +
  inset_element(pcol, left = 0.6, bottom = 0.65, right = 0.6, top = 1)
