...
pcol <- pop_comparison %>% 
 ...
 geom_col(aes(transit_supply, perc, fill = transit_supply)) +
  ...
  coord_flip() +
  scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33","lightgreen", "green", "darkgreen"))
...
Figure \ref{fig:Greater_Melbourne_2016_2021_ratio_map} shows changes in SI scores
...
Table \ref{tab:Greater_Melbourne_2016_2021_ratio_map} shows changes in SI score
...
pcol_vhigh_vlow_zero <- melbourne_needs_gap_sa1_2016  %>%
  ...
  coord_flip() +
  scale_fill_manual(values = c("red", "red", "#F7C387", "#F29C33", "lightgreen", "#53A212", "darkgreen")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
  labs(
...
pcol_mornington <- left_join(data.frame(ratio_binned_collapsed=levels(si_by_areaSA12016_2016_2021_wider$ratio_binned_collapsed)),
 ...
 Greater_MelbourneSA12016_2016_2021_ratio_map +
  ggspatial::annotation_scale(location = 'br') + 
  ggspatial::annotation_north_arrow(location = 'tr') + 
  inset_element(pcol, left = 0.0, bottom = 0.0, right = 0.55, top =0.25) +
  ...
  inset_element(pcol_north_east, left = 0.6, bottom = 0.83, right = 0.9, top =0.98)  +
  inset_element(pcol_north_west, left = 0.0, bottom = 0.83, right = 0.3, top =0.96) +
...
and \ref{tab:Greater_Melbourne_population_2021_by_SA4})
and mapped (Figure \ref{fig:Greater_Melbourne_2016_2021_ratio_map}).
...
```{r Bus_798, fig.show="hold", eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.ncol = 2, out.width = "50%", fig.align = "center", fig.show="hold",  fig.cap="Cranbourne and Selandra Rise", fig.subcap=c("Bus Route 798 as originally introduced in 2014 (Source: Delbosc et al (2015))", "Surrounding transit routes (2019)", "Surrounding transit routes (2021)", "Surrounding transit routes (2024)(Source: PTV)")}


knitr::include_graphics("graphics/Route798.png")
knitr::include_graphics("graphics/Cranbourne2019.png")
...
```{r Selandra_rise, fig.show="hold", eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.ncol = 2, fig.height=1.3, fig.width=3.8,fig.align = "center", fig.show="hold", fig.cap="Cranbourne and the Selandra Rise Estate", fig.subcap = c("Transport Supply by SA1: 2016", "Transport Supply by population: 2016", "Transport Supply by SA1: 2021", "Transport Supply by population: 2021", "Change in SI score 2016 to 2021, by SA1", "Change in SI score 2016 to 2021, by 2021 population", "Social Need by SA1: 2021", "Social Need by population: 2021", "Needs-gap: SA1s with Very High needs in 2021, by supply", "Needs-gap: population with Very High needs in 2021, by supply")}
...
```{r Greater_Melbourne_2016_social_needs_appendix, out.width="100%", echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE,  fig.cap="Distribution of categories of composite social need index scores in 2016 (left) and 2021 (right), overlayed with: 2006 Greater Melbourne boundary (black); middle/outer and inner/middle suburb boundaries (grey); and suburban railway lines (black)."}
