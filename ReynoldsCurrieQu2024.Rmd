...
Figure \ref{fig:Greater_Melbourne_CCDs_SA1_population} 
shows the spatial distribution of 
Transport Supply by SA1 in 2021. 
Additional maps by CCD and for 2016 are included in the Appendix. 
...
```{r Greater_Melbourne_population_2016_by_SA4, fig.show="hold", echo = FALSE, fig.height=8, warning=FALSE, message=FALSE, cache=FALSE, fig.fullwidth = TRUE, fig.cap="Greater Melbourne 2021: Transport Supply"}
...
```{r Greater_Melbourne_population_2021_by_SA4, fig.show="hold", echo = FALSE, fig.height=8, warning=FALSE, message=FALSE, cache=FALSE, fig.fullwidth = TRUE, fig.cap="Greater Melbourne 2021: Transport Supply"}
...
pcol_mornington <- melbourne_2021_population_transit_supply_by_SA4 %>% 
  ...
  geom_col(aes(transit_supply, population, fill = transit_supply)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 16000, label = glue::glue("{label_percent(accuracy =0. 1)(perc)}")), size = 1.8) +
  coord_flip() +
  scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
pcol_inner_east <- melbourne_2021_population_transit_supply_by_SA4 %>% 
  ...
  geom_col(aes(transit_supply, population, fill = transit_supply)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 21000, label = glue::glue("{label_percent(accuracy =0. 1)(perc)}")), size = 1.8) +
  coord_flip() +
  scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
pcol_inner_south <- melbourne_2021_population_transit_supply_by_SA4 %>% 
  ...
  geom_col(aes(transit_supply, population, fill = transit_supply)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 32000, label = glue::glue("{label_percent(accuracy =0. 1)(perc)}")), size = 1.8) +
  coord_flip() +
  scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
pcol_north_east <- melbourne_2021_population_transit_supply_by_SA4 %>% 
  ...
  geom_col(aes(transit_supply, population, fill = transit_supply)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 14000, label = glue::glue("{label_percent(accuracy =0. 1)(perc)}")), size = 1.8) +
  coord_flip() +
  scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
pcol_north_west <- melbourne_2021_population_transit_supply_by_SA4 %>% 
  ...
  geom_col(aes(transit_supply, population, fill = transit_supply)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 13000, label = glue::glue("{label_percent(accuracy =0. 1)(perc)}")), size = 1.8) +
  coord_flip() +
  scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
pcol_outer_east <- melbourne_2021_population_transit_supply_by_SA4 %>% 
  ...
  geom_col(aes(transit_supply, population, fill = transit_supply)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 19000, label = glue::glue("{label_percent(accuracy =0. 1)(perc)}")), size = 1.8) +
  coord_flip() +
  scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
pcol_south_east <- melbourne_2021_population_transit_supply_by_SA4 %>% 
  ...
  geom_col(aes(transit_supply, population, fill = transit_supply)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 25000, label = glue::glue("{label_percent(accuracy =0. 1)(perc)}")), size = 1.8) +
  coord_flip() +
  scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
pcol_inner <- melbourne_2021_population_transit_supply_by_SA4 %>% 
  ...
  geom_col(aes(transit_supply, population, fill = transit_supply)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 70000, label = glue::glue("{label_percent(accuracy =0. 1)(perc)}")), size = 1.8) +
  coord_flip() +
  scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
melbourne_si_SA12021_21_plot_with_graphs <- melbourne_si_SA12021_21_plot + 
  inset_element(pcol, left = 0.0, bottom = 0.17, right = 0.42, top =0.33) +
  inset_element(pcol_mornington, left = 0.15, bottom = 0.0, right = 0.40, top =0.15) +
  ...
  inset_element(pcol_inner_east, left = 0.57, bottom = 0.60, right = 0.70, top =0.73) 

melbourne_si_SA12021_21_plot_with_graphs
...
pcol <- melbourne_needs_gap_sa1_2021  %>%
  ...
  geom_col(aes(transit_supply, population, fill = transit_supply)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 110000, label = glue::glue("{label_percent(accuracy = 0.1)(perc)}")), size = 1.8) +
  coord_flip() +
  scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
