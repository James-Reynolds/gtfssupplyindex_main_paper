...
inset_element(pcol, left = 0.0, bottom = 0.0, right = 0.40, top =0.30) +
  ...
  inset_element(pcol_north_east, left = 0.57, bottom = 0.80, right = 0.87, top =0.95)  +
  inset_element(pcol_north_west, left = 0.0, bottom = 0.81, right = 0.3, top =0.96) +
  ...
  inset_element(pcol_inner_south, left = 0.33, bottom = 0.25, right = 0.63, top =0.4) +
  inset_element(pcol_inner_east, left = 0.57, bottom = 0.59, right = 0.87, top =0.72) 
...
Greater_Melbourne_2016_2021_ratio_map +
  ...
  inset_element(pcol, left = 0.0, bottom = 0.0, right = 0.48, top =0.38) +
  inset_element(pcol_mornington, left = 0.61, bottom = 0.05, right = 0.91, top =0.2) +
  ...
  inset_element(pcol_north_east, left = 0.61, bottom = 0.85, right = 0.91, top =1)  +
  ...
  inset_element(pcol_inner, left = 0.34, bottom = 0.33, right = 0.64, top =0.48) +
  inset_element(pcol_inner_south, left = 0.34, bottom = 0.18, right = 0.64, top =0.33) + inset_element(pcol_inner_east, left = 0.75, bottom = 0.7, right = 1.05, top =0.85)  
...
inset_element(pcol, left = 0.0, bottom = 0.0, right = 0.4, top =0.30) +
  inset_element(pcol_mornington, left = 0.6, bottom = 0.04, right = 0.9, top =0.19) +
  ...
  inset_element(pcol_north_west, left = 0.0, bottom = 0.81, right = 0.3, top =0.96) +
  inset_element(pcol_west, left = 0.00, bottom = 0.32, right = 0.3, top =0.47) +
  inset_element(pcol_inner, left = 0.28, bottom = 0.32, right = 0.58, top =0.47) +
  inset_element(pcol_inner_south, left = 0.34, bottom = 0.20, right = 0.64, top =0.35) +  inset_element(pcol_inner_east, left = 0.75, bottom = 0.78, right = 1.05, top =0.93) 
...
```{r Greater_Melbourne_2021_needs_gap_map_figure, eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.dim=c(7.5,7.5),  fig.cap="Greater Melbourne 2021: Very High needs SA1s (only) Transport Supply groupings,"}
...
inset_element(pcol, left = 0.0, bottom = 0.0, right = 0.4, top =0.30) +
  ...
  inset_element(pcol_south_east, left = 0.82, bottom = 0.03, right = 1.12, top =0.17) +
  inset_element(pcol_outer_east, left = 0.82, bottom = 0.70, right = 1.12, top =0.85) +
  inset_element(pcol_north_east, left = 0.6, bottom = 0.80, right = 0.9, top =0.95)  +
  inset_element(pcol_north_west, left = 0.0, bottom = 0.81, right = 0.3, top =0.96) +
  inset_element(pcol_west, left = 0.00, bottom = 0.35, right = 0.3, top =0.5) +
  inset_element(pcol_inner, left = 0.3, bottom = 0.35, right = 0.6, top =0.5) +
  inset_element(pcol_inner_south, left = 0.34, bottom = 0.20, right = 0.64, top =0.35) +  inset_element(pcol_inner_east, left = 0.75, bottom = 0.78, right = 1.05, top =0.93) 
...
a further `r (si_by_areaSA12016_2016_2021_wider_table[4,"North East"] %>% sum() - (si_by_areaSA12016_2016_2021_wider_table[4,"North East"] + si_by_areaSA12016_2016_2021_wider_table[4,"West"] + si_by_areaSA12016_2016_2021_wider_table[4,"Mornington Peninsula"]) %>% sum() %>% format(big.mark = ",")`
...
melbourne_si_SA12016_16_census_week_aggregated$si_by_area %>%
  ...
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, population + 8000, label = glue::glue("{label_comma(accuracy = 1, big.mark = ",")(population)} ({label_percent(accuracy = 1)(perc)})")), size = 3) +
   coord_flip() + 
 scale_fill_manual(values = c("white", "#F9D8B1", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
combined_needs_index_2021_sa1_greater_melbourne %>%
 ...
 geom_col(aes(composite_needs, perc, fill = composite_needs), colour="black") +
  scale_y_continuous(limits = c(0,0.7)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(composite_needs, perc+0.04, label = glue::glue("{label_percent(accuracy = 1)(perc)}")), size = 3) +
   coord_flip() +
  scale_fill_manual(values = c("#FFFB07", "#CEE102", "#A3CF07", "#61AE09", "#2EA105", "#0A7B01")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
#        legend.key.size = unit(0.08, 'cm')
  ...
  ggrepel::geom_label_repel(
    data = melbourne_needs_gap_sa1_2021 %>% 
          filter(very_high_needs_very_low_zero_supply_2021 == TRUE),
    aes(label = population, geometry = geometry),
    stat = "sf_coordinates",
    min.segment.length = 0 ) +
  geom_sf(data=melbourne_sd07aust_region, fill = NA, linewidth = 0.5) +
...
melbourne_needs_gap_sa1_2021 %>% 
 ...
 geom_col(aes(transit_supply, perc, fill = transit_supply), colour="black") +
  scale_y_continuous(limits = c(0,0.7)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(transit_supply, perc+0.05, label = glue::glue("{label_percent(accuracy = 1)(perc)}")), size = 3) +
  coord_flip() +
  scale_fill_manual(values = c("darkred", "red", "#F7C387", "#F29C33", "#5DB000", "#53A212", "#407F0B")) + 
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
