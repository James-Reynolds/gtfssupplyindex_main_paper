...
Greater_Melbourne_2016_2021_ratio_map +
  ...
  inset_element(pcol_outer_east, left = 0.7, bottom = 0.85, right = 1.0, top =1) +
  inset_element(pcol_north_east, left = 0.53, bottom = 0.85, right = 0.83, top =1)  +
  inset_element(pcol_north_west, left = 0.0, bottom = 0.65, right = 0.3, top =0.8) +
  ...
  inset_element(pcol_inner_south, left = 0.32, bottom = 0.17, right = 0.62, top =0.32) +
  inset_element(pcol_inner_east, left = 0.7, bottom = 0.7, right = 1, top =0.85)  
...
pcol <- si_by_areaSA12016_2016_2021_wider %>% 
 ...
 geom_col(aes(ratio_binned_collapsed, perc, fill = ratio_binned_collapsed), colour="black") +
  scale_y_continuous(limits = c(0,0.7)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(ratio_binned_collapsed, perc+0.05, label = glue::glue("{label_percent(accuracy = 1)(perc)}")), size = 3.5, colour = "white") +
  coord_flip() +
  scale_fill_manual(values = c("#3A65A3", "#C2DFEB", "#EFA15C", "#BA3832", "black")) +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
