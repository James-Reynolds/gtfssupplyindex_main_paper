...
while others may be complicated for communication
with the public,
decision-makers
...
may make it possible for others
to apply the SI calculation
across even relatively large transit networks,
as has been shown for Greater Melbourne here,
...
and this is a part of Greater Melbourne has received attention in previous research  [@delbosc2015impact] about bus services
in new developments. 

This research included a case study of the Selandra Rise estate,
east of Cranbourne, 
...
overlayed with the surrounding transit routes.
...
Figure \ref{fig:Selandra_rise}(i) shows how
new services appear to have been sufficient to shift some of the estate 
