---
title: "Social needs for transport and gaps in transit service: new GTFS tools; Appendix materials"
author:
  - name: James Reynolds
...
```{r Bus_798, fig.show="hold", eval = FALSE, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.ncol = 2, out.width = "50%", fig.align = "center", fig.show="hold",  fig.cap="Cranbourne and Selandra Rise", fig.subcap=c("Transit routes: 2014 (Source: Delbosc et al (2015) overlaid on PTV(2014))", "Transit routes: 2021 (Source: PTV(2021))")}
...
```{r Greater_Melbourne_SA12016_plot_appendix, include = TRUE, fig.show="hold", echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.dim = c(7.5,7.5), fig.cap="Greater Melbourne 2016: Transport Supply by SA1, overlayed with suburban rail network (black), SA4 boundaries (blue) and 2006 Melbourne extents (black)"}
...
```{r Greater_Melbourne_2021_sa1_supply_table, include = TRUE,  echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE}
...
```{r Greater_Melbourne_ratio_sa1_table, include = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE}
greater_melbourne_ratio_SA1_table

```

```{r Greater_Melbourne_2016_social_needs_appendix, include = TRUE,  fig.dim=c(7.5, 7.5), echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE,  fig.cap="Distribution of categories of composite social need index scores in 2016 overlayed with: 2006 Greater Melbourne boundary (black); SA4 boundaries (blue) and suburban railway lines (black)."}
...
```{r Greater_Melbourne_2016_needs_gap_scatterplot_figure, include = TRUE,  fig.show="hold", eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.fullwidth = TRUE, fig.height=8, fig.cap="Greater Melbourne 2016, SI and Combined Needs Index scores, with SI scores < 10 rounded up to equal 10. "}
...
```{r Greater_Melbourne_si_by_area_2016_2021_wider_table_sa1_appendix_table, include = TRUE,  eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE}
