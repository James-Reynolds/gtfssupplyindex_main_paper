...
- some middle south-eastern suburbs along the bay (vicinty of Black Rock) have dropped below average;
...
```{r Greater_Melbourne_2016_2021_plot, fig.show="hold", echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.fullwidth = TRUE, fig.cap="Greater Melbourne, Transit Supply by 2021 SA1 for the weeks starting the date of 2016 and 2021 census, overlayed with: 2006 Greater Melbourne boundary (black); 2021 SA4 boundaries (grey); and suburban railway lines (dashed)"}
...
sa1_comparison <- melbourne_comparison_2006_2021 %>% 
             select(transit_supply, sa1s_2016, sa1s_2021) %>% 
             pivot_longer(
    cols = 2:3,
    names_to = "category", 
    values_to = "counts")
...
sa1_comparison$category<- factor(
  sa1_comparison$category, levels = c("sa1s_2016", "sa1s_2021"))
