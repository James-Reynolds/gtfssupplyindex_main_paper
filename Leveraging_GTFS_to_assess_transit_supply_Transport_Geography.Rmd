...
```{r Greater_Melbourne_CCD_2021, fig.show="hold", out.width="100%",  echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.cap="Transport Supply by CCD, week starting the day of the 2021 census"}
...
with higher levels of transit supply in inner areas and close to most railway lines.
- There are still many areas with very low or zero transit supply, especially in outer areas. 
However, .  
