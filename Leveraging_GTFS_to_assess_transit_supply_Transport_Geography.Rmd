...
###2020
si_by_area_and_hour_220809_tram <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_220809_tram")
...
si_by_area_and_hour_220809_rail <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_220809_rail")
...
si_by_area_and_hour_220809_bus <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_220809_bus")
...
#####
###Load results from CSV (Precalculated above) and make first column character
si_by_area_and_hour_180814_tram <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_180814_tram")
...
si_by_area_and_hour_180814_rail <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_180814_rail")
...
si_by_area_and_hour_180814_bus <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_180814_bus")
...
#####
###Load results from CSV (Precalculated above) and make first column character
si_by_area_and_hour_170808_tram <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_170808_tram")
...
si_by_area_and_hour_170808_rail <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_170808_rail")
...
si_by_area_and_hour_170808_bus <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_170808_bus")
...
#####
###Load results from CSV (Precalculated above) and make first column character
si_by_area_and_hour_160809_tram <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_160809_tram")
...
si_by_area_and_hour_160809_rail <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_160809_rail")
...
si_by_area_and_hour_160809_bus <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_160809_bus")
...
#####
###Load results from CSV (Precalculated above) and make first column character
si_by_area_and_hour_150811_tram <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_150811_tram")
...
si_by_area_and_hour_150811_rail <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_150811_rail")
...
si_by_area_and_hour_150811_bus <- read.csv("results/Greater_Melbourne/si_by_SA12021area_and_hour_150811_bus")
...
names(si_by_area_by_year_sa3) <- c('sa3_name_2021', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023')
...
```{r Greater_Melbourne_map, fig.show="hold", echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, fig.cap="SI values for August 8, 2023, by mode"}

si_by_area_by_year_sa3_longer_2016_2021 <- left_join(
  (absmapsdata::sa32021 %>% 
              filter(gcc_name_2021 == "Greater Melbourne") %>% 
              select(sa3_name_2021)), 
   (si_by_area_by_year_sa3_longer %>% 
     filter(Year == "2016" | Year == "2021")))
          

plot_2016_versus_2021 <- ggplot() + 
  geom_sf(data=si_by_area_by_year_sa3_longer_2016_2021 %>% na.omit(),
          aes(fill = SI)) +
...
si_by_area_by_year_sa3$'SI change' <- si_by_area_by_year_sa3$'2021' -   si_by_area_by_year_sa3$'2016'


si_by_area_by_year_sa3 <- left_join(
  (absmapsdata::sa32021 %>% 
              filter(gcc_name_2021 == "Greater Melbourne") %>% 
              select(sa3_name_2021)), 
  si_by_area_by_year_sa3)
          


plot_2016_change_2021 <- ggplot() + 
  geom_sf(data=si_by_area_by_year_sa3 %>% na.omit(),
          aes(fill = `SI change`)) +
  theme(axis.text.x=element_blank(), #remove x axis labels
        axis.ticks.x=element_blank(), #remove x axis ticks
        axis.text.y=element_blank(),  #remove y axis labels
...
si_by_area_by_year_sa3$'SI percent change' <- 
  (si_by_area_by_year_sa3$'2021' - 
  si_by_area_by_year_sa3$'2016') /  
  si_by_area_by_year_sa3$'2021'

plot_2016_percent_change_2021 <- ggplot() + 
  geom_sf(data=si_by_area_by_year_sa3 %>% na.omit(),
          aes(fill = `SI percent change`)) +
  theme(axis.text.x=element_blank(), #remove x axis labels
        axis.ticks.x=element_blank(), #remove x axis ticks
        axis.text.y=element_blank(),  #remove y axis labels
        axis.ticks.y=element_blank()  #remove y axis ticks 
  ) +
  scale_fill_distiller(labels = scales::percent_format(), palette = "Spectral") 


  
plot_2016_versus_2021  / 
(plot_2016_change_2021 + plot_2016_percent_change_2021)
