...
# Introduction
A motivation for providing a basic level of 
transit service is to enable those who cannot otherwise drive themselves to have at least some mobility and accessibility 
...
especially those related to vertical equity 
and better supporting those who are disadvantaged 
(c.f. @Litman:2016aa), 
...
This was applied to a case study of Melbourne in 2006 in @Currie2007Identifying; @currie2010identifying.
...
large task requiring data to be sourced, 
...
It also facilitates data access and processing for research purporsesx. 
However, tools
for using GTFS data 
to examine spatial 
patterns and gaps 
...
which are compared to the 2006 analysis reported in @currie2010identifying^[The wider programme of research includes examination of spatial gaps in other cities, so as to better understand whether patterns in Melbourne are representative of other places. However, this paper is limited to examining Melbourne in 2016 and 2021 only. Results for other cities will be reported elsewhere.].
...
Limitations of this study and directions for future research are discussed in Section 6, which also includes a brief conclusion
...
or generated 
for proposed changes to a network. 
...
(e.g. for communication with the public, politicians or other stakeholders).
...
These were used to categorised service levels into seven groups, as shown in 
...
```{r outer_east_changes, fig.show="hold", eval = FALSE, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.dim = c(7.5,7.5), fig.cap="Greater Melbourne SA1s with Very High transport need and Zero or Very Low supply in 2021, population by change in SI score 2016 to 2021, across SA4."}
