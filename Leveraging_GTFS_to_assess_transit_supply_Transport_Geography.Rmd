...
```{r Currie_map_SI, fig.cap = "Melbourne 2006: Distribution of supply measure scores (top), needs (middle) and gaps (bottom), Source: Currie (2010)",  echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, out.width='100%'}
...
Table \ref{tab:Greater_Melbourne_2016_2021_ratio_population_table} summarises changes in SI score between 2016 and 2021 (column 1) by SA1s for the 2021 population, summarised for each SA4 zone (columns 2 to 10) and Greater Melbourne as a whole (column 11).
