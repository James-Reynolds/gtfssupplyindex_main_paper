...
```{r Gini_coefficients, fig.cap = "Victorian GTFS and SA1 zones within Greater Melbourne, SI values for Tuesday August 8, 2023", echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE}
...
X2021Census_G01_VIC_SA1 <- read_csv("data/2021_GCP_SA1_for_VIC_short-header/2021 Census GCP Statistical Area 1 for VIC/2021Census_G01_VIC_SA1.csv")
X2021Census_G01_VIC_SA1$SA1_CODE_2021 <- as.character(X2021Census_G01_VIC_SA1$SA1_CODE_2021)
#join_to_SI_scores
...
names(si_by_area_230808) <- c("area_id", "SI", "2021 population")

ggplot(si_by_area_230808, mapping = aes(x = SI, n = `2021 population`) + 
  stat_lorenz() +
  geom_abline(linetype = "dashed") +
  theme_bw() +
  labs(x = "Cumulative share SI score", y = "Cumulative share of population") +
  #scale_x_continuous(labels = scales::percent()) + 
  #scale_y_continuous(labels = scales::percent()) + 
  annotate_ineq(measure_ineq = "Gini", color = "red",
