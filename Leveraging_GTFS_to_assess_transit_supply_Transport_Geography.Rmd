...
transit supply 
so as 
to compare the two across geographic areas.
However, such methodologies 
do not appear to have often 
been used again
in further research, 
such as to examine other cases 
or time periods. 
...
and so might be more an activity of 
practitioner than researchers. 
