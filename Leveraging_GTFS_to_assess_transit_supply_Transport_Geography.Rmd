...
si_by_areaSA12016_2016_2021_wider %>% 
  ...
  adorn_pct_formatting() %>%
  adorn_ns() %>%
  kable(caption = "Greater Melbourne: 2016 residents living in areas with Very High needs but Very Low or Zero supply, by SA4 and change in SI from 2016 to 2021",
      align = "lrrrrrrrrr",
      col.names = c("Change", 
                   "Inner", "Inner South",
                   "North East", "North West",
