...
### 2021 SI scores - SA1s
The 2006 census was the last to use CCDs. Population and other data was instead reported for SA1s in 2021, and Figure \ref{fig:Greater_Melbourne_SA1_2021_plot} shows the 2021 Transit Supply groupings using these zones. Greater Melbourne now covers a larger spatial area, and so Figure \ref{fig:Greater_Melbourne_SA1_2021_plot} shows includes all SA1 zones within the 2021 GCCSA boundary. The 2006 GCCSA boundary is also shown for comparison purposes. Table \ref{tab:Greater_Melbourne_SA1_2021_table} and Figure \ref{fig:Greater_Melbourne_SA1_2021_table} compare number of CCD and SA1 zones in each category in 2006 and 2021, as well as the share of Greater Melbourne's population living in zones within each category. 
