...
## Central Melbourne
Figure \@ref(CBD_map)) shows SA1 zones in central Melbourne, including the Central Business District (CBD). 
```{r CBD_map, crop = TRUE, fig.cap = "SA1 zone boundaries in central Melbourne.",  echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, out.width='100%'}
...
```{r Melbourne_CBD_map_230808, echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.fullwidth = TRUE, crop = TRUE, fig.cap="Victorian GTFS and central Melbourne SA1 zones, SI values for October 10, 2023, by hour between 5am and 10am"}
...
The results shown in Figure \@ref(Melbourne_CBD_map_230808) meet expectations, with higher SI scores shown in the Central Business District (CBD), where there are the five stations that make up the City Loop^[Flinders Street Station, Southern Cross Station, Flagstaff Station, Melbourne Central Station and Parliament Station.], and where many tram and bus routes converge. The SI scores are highest between 7-9am, reflecting the typical service peaks. 

Figure \@ref(Melbourne_230808_by_mode) shows SI scores by mode for all of Tuesday August 8, 2023, again for central . 

```{r Melbourne_230808_by_mode, crop = TRUE, fig.cap = "Victorian GTFS and SA1 zones near the Melbourne CBD, SI values for Tuesday August 8, 2023, by mode", echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE}
...
Figure \@ref(Melbourne_230808_by_mode) indicates how the central city is serviced by:
 ...
 - rail services stopping at City Loop stations; and  - tram services, most of which running north-south along the Swanston Street corridor.  
...
```{r Melbourne_230808_by_hour, crop = TRUE, fig.cap = "Victorian GTFS and SA1 zones in Greater Melbourne, SI values for Tuesday August 8, 2023, by hour", echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE}

ggwithinstats(
  data = si_by_area_and_hour_230808,
  x = hour_starting,
  y = SI,
...
```{r Melbourne_230808_by_hour_by_mode, crop = TRUE, fig.cap = "Victorian GTFS and SA1 zones in Greater Melbourne, SI values for Tuesday August 8, 2023, by hour", echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE}

ggwithinstats(
  data = si_by_area_and_hour_230808_all_modes,
  x = hour_starting,
  y = SI,
  #type = "nonparametric", ## type of statistical test
  xlab = "Hour starting", ## label for the x-axis
...
```{r gghistostats, crop = TRUE, fig.cap = "Victorian GTFS and SA1 zones within Greater Melbourne, SI values for Tuesday August 8, 2023", echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE}
...
```{r gghistostats_by_sa3, crop = TRUE, fig.cap = "Victorian GTFS and SA1 zones within Greater Melbourne, SI values for Tuesday August 8, 2023", echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE}
