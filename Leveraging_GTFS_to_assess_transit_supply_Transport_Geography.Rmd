...
```{r run_for_all_modes_Victoria_210811, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_210805_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_210805/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_210812, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_210805_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_210805/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_210813, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_210805_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_210805/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_210814, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_210805_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_210805/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_210815, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_210805_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_210805/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_210816, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_210805_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_210805/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_160810, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_160804_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_160804/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_160811, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_160804_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_160804/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_160812, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_160804_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_160804/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_160813, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_160804_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_160804/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_160814, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_160804_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_160804/gtfs_duplicate_stops_removed.zip")
...
```{r run_for_all_modes_Victoria_160815, eval = TRUE, echo = FALSE}
## convert to list of tidygtfs objects
ptv_160804_list_gtfs <- gtfssupplyindex::gtfs_by_route_type("data/ptv_160804/gtfs_duplicate_stops_removed.zip")
