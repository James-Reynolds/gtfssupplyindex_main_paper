---
title: "Leveraging GTFS to explore spatial gaps in transit supply with respect to social needs: Sydney case report"
author:
  - name: James Reynolds
...
# Introduction
This is a case report associated with research undertaking an assessment of gaps between social needs for transport and the amount of transit supplied. The three main objectives of this research are: 
...
This case report presents results for Sydney in 2016 and 2024. 
The remainder of this document is structured as follows:
Section 2 describes the study methodology, 
followed by presentation of results in Section 3 
and discussion in Section 4. 


# Methodology
SI scores were calculated for other
...
# Results
## Greater Sydney: 2016 and 2021. 
### Transport Supply Categories 


## Sydney 2024 railway line locations - make shape files

```{r Greater_Sydney_2024_railway_shapes, eval = FALSE, echo = FALSE, warning = FALSE, message = FALSE, cache = FALSE}
...
sydney2024_railway_trips_shape <- sydney_240607_list_gtfs [[2]] %>% 
...
```{r Greater_Sydney_SA1_2021_plot, fig.show= "hold", out.width = "100%", echo = FALSE, warning = FALSE, message = FALSE, cache = FALSE, fig.fullwidth = TRUE, fig.cap = "Greater Sydney, Transit Supply by SA1 for week starting the date of 2021 census, overlayed SA4 boundaries (grey); and suburban railway lines (dashed)."}
...
## 2021 Greater Sydney
si_by_area <-  read.csv( "results/Greater_Sydney/sydney_si_SA12021_240806_week_aggregated.csv") %>% 
  as_tibble()
...
sydney_si_SA12021_21_census_week_aggregated <- si_thresholds_and_plot_function(si_by_area, areas_of_interest)

sydney_si_SA12021_21_census_week_aggregated$output_plot + 
